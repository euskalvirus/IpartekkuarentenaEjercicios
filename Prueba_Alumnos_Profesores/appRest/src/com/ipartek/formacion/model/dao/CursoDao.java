...
public class CursoDao implements IDAO<Curso> {
	...
	private final static String sql_get_all = "SELECT  id, titulo, imagen, precio FROM curso ORDER BY id ASC LIMIT 500";
	private final static String sql_get_by_id = "SELECT  id, titulo, imagen, precio FROM curso WHERE id= ?";
